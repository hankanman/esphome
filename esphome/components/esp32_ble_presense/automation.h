...
#include "esphome/components/esp32_ble_presense/esp32_ble_presense.h"
...
class ESPBTAdvertiseTrigger : public Trigger<const ESPBTDevice &>, public ESPBTDeviceListener {
 public:
  explicit ESPBTAdvertiseTrigger(ESP32BLEPresense *parent) { parent->register_listener(this); }
...
class BLEServiceDataAdvertiseTrigger : public Trigger<const adv_data_t &>, public ESPBTDeviceListener {
 public:
  explicit BLEServiceDataAdvertiseTrigger(ESP32BLEPresense *parent) { parent->register_listener(this); }
...
class BLEManufacturerDataAdvertiseTrigger : public Trigger<const adv_data_t &>, public ESPBTDeviceListener {
 public:
  explicit BLEManufacturerDataAdvertiseTrigger(ESP32BLEPresense *parent) { parent->register_listener(this); }
  void set_address(uint64_t address) { this->address_ = address; }
...
class BLEEndOfScanTrigger : public Trigger<>, public ESPBTDeviceListener {
 public:
  explicit BLEEndOfScanTrigger(ESP32BLEPresense *parent) { parent->register_listener(this); }
...
template<typename... Ts> class ESP32BLEStartScanAction : public Action<Ts...> {
 public:
  ESP32BLEStartScanAction(ESP32BLEPresense *parent) : parent_(parent) {}
 ...
 protected:
  ESP32BLEPresense *parent_;
};

template<typename... Ts> class ESP32BLEStopScanAction : public Action<Ts...>, public Parented<ESP32BLEPresense> {
 public:
