...
class ESPBTDeviceListener {
 public:
  ...
  void set_parent(ESP32BLEPresense *parent) { parent_ = parent; }

 protected:
  ESP32BLEPresense *parent_{nullptr};
};
...
class ESP32BLEPresense : public Component, public GAPEventHandler, public GATTcEventHandler, public Parented<ESP32BLE> {
 public:
...
// NOLINTNEXTLINE
extern ESP32BLEPresense *global_esp32_ble_presense;
